...
export class ColorNoHex implements RuleInterface {
    id: string = 'color-no-hex';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow hex colors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/color-no-hex';
