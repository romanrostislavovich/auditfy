...
export class AtRuleDisallowedList implements RuleInterface {
    id: string = 'at-rule-disallowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of disallowed at-rules.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/at-rule-disallowed-list';
