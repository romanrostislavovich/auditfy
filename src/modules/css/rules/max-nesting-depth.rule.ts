...
export class MaxNestingDepth implements RuleInterface {
    id: string = 'max-nesting-depth';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Limit the depth of nesting.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/max-nesting-depth';
