...
export class SelectorClassPattern implements RuleInterface {
    id: string = 'selector-class-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for class selectors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-class-pattern';
