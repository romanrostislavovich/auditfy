...
export class CommentPattern implements RuleInterface {
    id: string = 'comment-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for comments.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/comment-pattern';
