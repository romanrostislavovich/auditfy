...
export class LayerNamePattern implements RuleInterface {
    id: string = 'layer-name-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for layer names.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/layer-name-pattern';
