...
export class UnitNoUnknown implements RuleInterface {
    id: string = 'unit-no-unknown';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown units.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/unit-no-unknown';
