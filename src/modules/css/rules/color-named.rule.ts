...
export class ColorNamed implements RuleInterface {
    id: string = 'color-named';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Require (where possible) or disallow named colors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/color-named';
