...
export class PropertyNoUnknown implements RuleInterface {
    id: string = 'property-no-unknown';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown properties.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/property-no-unknown';
