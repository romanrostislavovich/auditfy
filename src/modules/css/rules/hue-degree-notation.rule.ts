...
export class HueDegreeNotation implements RuleInterface {
    id: string = 'hue-degree-notation';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify number or angle notation for degree hues.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/hue-degree-notation';
