...
export class FunctionNameCase implements RuleInterface {
    id: string = 'function-name-case';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify lowercase or uppercase for function names.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/function-name-case';
