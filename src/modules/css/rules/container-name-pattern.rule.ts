...
export class ContainerNamePattern implements RuleInterface {
    id: string = 'container-name-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for container names.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/container-name-pattern';
