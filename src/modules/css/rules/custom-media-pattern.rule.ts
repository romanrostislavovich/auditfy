...
export class CustomMediaPattern implements RuleInterface {
    id: string = 'custom-media-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for custom media query names.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/custom-media-pattern';
