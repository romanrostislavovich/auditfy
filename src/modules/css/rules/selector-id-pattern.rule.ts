...
export class SelectorIdPattern implements RuleInterface {
    id: string = 'selector-id-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for ID selectors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-id-pattern';
