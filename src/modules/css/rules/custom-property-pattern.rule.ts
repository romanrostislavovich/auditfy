...
export class CustomPropertyPattern implements RuleInterface {
    id: string = 'custom-property-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for custom properties.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/custom-property-pattern';
