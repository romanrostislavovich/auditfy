...
export class AtRuleNoVendorPrefix implements RuleInterface {
    id: string = 'at-rule-no-vendor-prefix';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow vendor prefixes for at-rules.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/at-rule-no-vendor-prefix';
