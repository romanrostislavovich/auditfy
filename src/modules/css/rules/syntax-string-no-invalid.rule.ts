...
export class SyntaxStringNoInvalid implements RuleInterface {
    id: string = 'syntax-string-no-invalid';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow invalid syntax strings.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/syntax-string-no-invalid';
