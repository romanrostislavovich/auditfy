...
export class PropertyAllowedList implements RuleInterface {
    id: string = 'property-allowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of allowed properties.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/property-allowed-list';
