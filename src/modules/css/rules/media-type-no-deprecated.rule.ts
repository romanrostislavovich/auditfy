...
export class MediaTypeNoDeprecated implements RuleInterface {
    id: string = 'media-type-no-deprecated';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow deprecated media types.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/media-type-no-deprecated';
