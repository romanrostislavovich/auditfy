...
export class SelectorMaxClass implements RuleInterface {
    id: string = 'selector-max-class';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Limit the number of classes in a selector.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-max-class';
