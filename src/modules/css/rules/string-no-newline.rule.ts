...
export class StringNoNewline implements RuleInterface {
    id: string = 'string-no-newline';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow invalid newlines within strings.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/string-no-newline';
