...
export class SelectorMaxSpecificity implements RuleInterface {
    id: string = 'selector-max-specificity';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Limit the specificity of selectors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-max-specificity';
