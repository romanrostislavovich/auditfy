...
export class ImportNotation implements RuleInterface {
    id: string = 'import-notation';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify string or URL notation for @import rules.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/import-notation';
