...
export class CommentNoEmpty implements RuleInterface {
    id: string = 'comment-no-empty';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow empty comments.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/comment-no-empty';
