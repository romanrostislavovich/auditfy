...
export class AtRuleAllowedList implements RuleInterface {
    id: string = 'at-rule-allowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of allowed at-rules.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/at-rule-allowed-list';
