...
export class ValueKeywordCase implements RuleInterface {
    id: string = 'value-keyword-case';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify lowercase or uppercase for keywords values.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/value-keyword-case';
