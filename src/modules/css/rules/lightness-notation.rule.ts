...
export class LightnessNotation implements RuleInterface {
    id: string = 'lightness-notation';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify number or percentage notation for lightness.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/lightness-notation';
