...
export class AtRuleNoUnknown implements RuleInterface {
    id: string = 'at-rule-no-unknown';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown at-rules.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/at-rule-no-unknown';
