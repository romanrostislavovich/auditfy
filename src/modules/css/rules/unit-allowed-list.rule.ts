...
export class UnitAllowedList implements RuleInterface {
    id: string = 'unit-allowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of allowed units.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/unit-allowed-list';
