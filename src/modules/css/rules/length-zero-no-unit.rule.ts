...
export class LengthZeroNoUnit implements RuleInterface {
    id: string = 'length-zero-no-unit';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow units for zero lengths.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/length-zero-no-unit';
