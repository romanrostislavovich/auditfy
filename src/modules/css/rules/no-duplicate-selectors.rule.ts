...
export class NoDuplicateSelectors implements RuleInterface {
    id: string = 'no-duplicate-selectors';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow duplicate selectors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/no-duplicate-selectors';
