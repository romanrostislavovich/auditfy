...
export class ColorHexAlpha implements RuleInterface {
    id: string = 'color-hex-alpha';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Require or disallow alpha channel for hex colors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/color-hex-alpha';
