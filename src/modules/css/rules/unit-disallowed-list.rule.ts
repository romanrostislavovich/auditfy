...
export class UnitDisallowedList implements RuleInterface {
    id: string = 'unit-disallowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of disallowed units.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/unit-disallowed-list';
