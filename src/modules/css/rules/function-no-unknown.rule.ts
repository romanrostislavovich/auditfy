...
export class FunctionNoUnknown implements RuleInterface {
    id: string = 'function-no-unknown';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown functions.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/function-no-unknown';
