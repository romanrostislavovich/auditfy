...
export class NoUnknownAnimations implements RuleInterface {
    id: string = 'no-unknown-animations';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown animations.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/no-unknown-animations';
