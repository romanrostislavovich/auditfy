...
export class PropertyNoDeprecated implements RuleInterface {
    id: string = 'property-no-deprecated';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow deprecated properties.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/property-no-deprecated';
