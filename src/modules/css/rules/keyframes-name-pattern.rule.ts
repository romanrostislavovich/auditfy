...
export class KeyframesNamePattern implements RuleInterface {
    id: string = 'keyframes-name-pattern';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a pattern for keyframe names.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/keyframes-name-pattern';
