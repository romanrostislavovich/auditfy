...
export class AnnotationNoUnknown implements RuleInterface {
    id: string = 'annotation-no-unknown';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown annotations.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/annotation-no-unknown';
