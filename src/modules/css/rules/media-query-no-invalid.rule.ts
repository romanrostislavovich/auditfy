...
export class MediaQueryNoInvalid implements RuleInterface {
    id: string = 'media-query-no-invalid';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow invalid media queries.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/media-query-no-invalid';
