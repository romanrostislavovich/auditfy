...
export class SelectorMaxType implements RuleInterface {
    id: string = 'selector-max-type';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Limit the number of type selectors in a selector.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-max-type';
