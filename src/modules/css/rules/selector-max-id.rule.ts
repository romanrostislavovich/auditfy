...
export class SelectorMaxId implements RuleInterface {
    id: string = 'selector-max-id';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Limit the number of ID selectors in a selector.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/selector-max-id';
