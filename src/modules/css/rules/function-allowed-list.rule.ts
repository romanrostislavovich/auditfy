...
export class FunctionAllowedList implements RuleInterface {
    id: string = 'function-allowed-list';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Specify a list of allowed functions.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/function-allowed-list';
