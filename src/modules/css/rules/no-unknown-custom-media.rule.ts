...
export class NoUnknownCustomMedia implements RuleInterface {
    id: string = 'no-unknown-custom-media';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow unknown custom media queries.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/no-unknown-custom-media';
