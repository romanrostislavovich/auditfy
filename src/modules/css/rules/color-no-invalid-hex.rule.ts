...
export class ColorNoInvalidHex implements RuleInterface {
    id: string = 'color-no-invalid-hex';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Disallow invalid hex colors.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/color-no-invalid-hex';
