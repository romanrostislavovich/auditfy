...
export class FunctionUrlQuotes implements RuleInterface {
    id: string = 'function-url-quotes';
    dom: CheerioAPI;
    tags: string[] = ['style'];
    ...
    description: string = 'Require or disallow quotes for urls.';
    ruleUrl: string = 'https://stylelint.io/user-guide/rules/function-url-quotes';
