...
export class SvgImgAltRule implements RuleInterface {
    id: string = 'svg-img-alt';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure <svg> elements with an img, graphics-document or graphics-symbol role have an accessible text';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/svg-img-alt?application=RuleDescription';
