...
export class AriaValidAttrValueRule implements RuleInterface {
    ...
    description: string = '`[aria-*]` attributes have valid values';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/aria-valid-attr-value';
