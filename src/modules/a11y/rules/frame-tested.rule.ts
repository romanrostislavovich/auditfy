...
export class FrameTestedRule implements RuleInterface {
    id: string = 'frame-tested';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure <iframe> and <frame> elements contain the axe-core script';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/frame-tested?application=RuleDescription';
