...
export class RoleImgAltRule implements RuleInterface {
    id: string = 'role-img-alt';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure [role="img"] elements have alternative text';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/role-img-alt?application=RuleDescription';
