...
export class CssOrientationLockRule implements RuleInterface {
    id: string = 'css-orientation-lock';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure content is not locked to any specific display orientation, and the content is operable in all display orientations';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/css-orientation-lock?application=RuleDescription';
