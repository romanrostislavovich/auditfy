...
export class LabelRule implements RuleInterface {
    id: string = 'label';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    ...
    description: string = 'Form elements have associated labels';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/label';
