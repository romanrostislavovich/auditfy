...
export class LinkNameRule implements RuleInterface {
    id: string = 'link-name';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    ...
    description: string = 'Links have a discernible name';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/link-name';
