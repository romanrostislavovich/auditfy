...
export class ButtonNameRule implements RuleInterface {
    ...
    description: string = 'Buttons have an accessible name';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/button-name';
