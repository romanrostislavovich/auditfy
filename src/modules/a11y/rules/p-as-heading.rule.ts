...
export class PAsHeadingRule implements RuleInterface {
    id: string = 'p-as-heading';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure bold, italic text and font-size is not used to style <p> elements as a heading';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/p-as-heading?application=RuleDescription';
