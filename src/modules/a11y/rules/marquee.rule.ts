...
export class MarqueeRule implements RuleInterface {
    id: string = 'marquee';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure <marquee> elements are not used';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/marquee?application=RuleDescription';
