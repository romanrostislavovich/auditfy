...
export class SummaryNameRule implements RuleInterface {
    id: string = 'summary-name';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure summary elements have discernible text';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/summary-name?application=RuleDescription';
