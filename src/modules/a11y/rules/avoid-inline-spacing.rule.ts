...
export class AvoidInlineSpacingRule implements RuleInterface {
    id: string = 'avoid-inline-spacing';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure that text spacing set through style attributes can be adjusted with custom stylesheets';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/avoid-inline-spacing?application=RuleDescription';
