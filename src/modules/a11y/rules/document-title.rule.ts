...
export class DocumentTitleRule implements RuleInterface {
    ...
    description: string = 'Document has a `<title>` element';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/document-title';
