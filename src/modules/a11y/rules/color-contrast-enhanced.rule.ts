...
export class ColorContrastEnhancedRule implements RuleInterface {
    id: string = 'color-contrast-enhanced';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure the contrast between foreground and background colors meets WCAG 2 AAA enhanced contrast ratio thresholds';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/color-contrast-enhanced?application=RuleDescription';
