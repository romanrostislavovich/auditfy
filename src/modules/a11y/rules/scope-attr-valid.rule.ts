...
export class ScopeAttrValidRule implements RuleInterface {
    id: string = 'scope-attr-valid';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure the scope attribute is used correctly on tables';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/scope-attr-valid?application=RuleDescription';
