...
export class ServerSideImageMapRule implements RuleInterface {
    id: string = 'server-side-image-map';
    dom: CheerioAPI;
    tags: string[] = ['a11y'];
    ...
    axeCore: AxeResults;
    description: string = 'Ensure that server-side image maps are not used';
    ruleUrl: string = 'https://dequeuniversity.com/rules/axe/4.10/server-side-image-map?application=RuleDescription';
