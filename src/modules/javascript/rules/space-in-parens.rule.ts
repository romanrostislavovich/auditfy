...
export class SpaceInParensRule implements RuleInterface {
     id: string = 'space-in-parens';
    ...
    description: string = "No spaces inside parentheses.";
    ruleUrl: string = 'http://eslint.org/docs/rules/space-in-parens';
