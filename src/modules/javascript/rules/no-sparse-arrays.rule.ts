...
export class NoSparseArraysRule implements RuleInterface {
     id: string = 'no-sparse-arrays';
    ...
    description: string = "Sparse arrays are not allowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-sparse-arrays';
