...
export class NoUselessEscapeRule implements RuleInterface {
     id: string = 'no-useless-escape';
    ...
    description: string = "No unnecessary use of escape.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-useless-escape';
