...
export class CommaSpacingRule implements RuleInterface {
     id: string = 'comma-spacing';
    ...
    description: string = "Commas should have a space";
    ruleUrl: string = 'http://eslint.org/docs/rules/comma-spacing';
