...
export class NoNewWrappersRule implements RuleInterface {
     id: string = 'no-new-wrappers';
    ...
    description: string = "No using primitive wrapper instances.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new-wrappers';
