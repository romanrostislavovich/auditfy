...
export class NoMultiSpacesRule implements RuleInterface {
     id: string = 'no-multi-spaces';
    ...
    description: string = "Do not use multiple spaces except for indentation.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-multi-spaces';
