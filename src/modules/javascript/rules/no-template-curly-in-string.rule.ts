...
export class NoTemplateCurlyInStringRule implements RuleInterface {
     id: string = 'no-template-curly-in-string';
    ...
    description: string = "Regular strings must not contain template literal placeholders.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-template-curly-in-string';
