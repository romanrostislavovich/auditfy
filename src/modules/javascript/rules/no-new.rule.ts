...
export class NoNewRule implements RuleInterface {
     id: string = 'no-new';
    ...
    description: string = "No new without assigning object to a variable.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new';
