...
export class YieldStarSpacingRule implements RuleInterface {
     id: string = 'yield-star-spacing';
    ...
    description: string = "The * in yield*expressions must have a space before and after.";
    ruleUrl: string = 'http://eslint.org/docs/rules/yield-star-spacing';
