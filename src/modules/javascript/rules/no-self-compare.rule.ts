...
export class NoSelfCompareRule implements RuleInterface {
     id: string = 'no-self-compare';
    ...
    description: string = "Avoid comparing a variable to itself.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-self-compare';
