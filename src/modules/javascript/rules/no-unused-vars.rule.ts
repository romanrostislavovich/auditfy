...
export class NoUnusedVarsRule implements RuleInterface {
     id: string = 'no-unused-vars';
    ...
    description: string = "No unused variables.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-unused-vars';
