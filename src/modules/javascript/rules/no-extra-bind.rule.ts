...
export class NoExtraBindRule implements RuleInterface {
     id: string = 'no-extra-bind';
    ...
    description: string = "Avoid unnecessary function binding.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-extra-bind';
