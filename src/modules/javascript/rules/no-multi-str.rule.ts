...
export class NoMultiStrRule implements RuleInterface {
     id: string = 'no-multi-str';
    ...
    description: string = "No multiline strings.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-multi-str';
