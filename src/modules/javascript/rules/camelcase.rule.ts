...
export class CamelcaseRule implements RuleInterface {
     id: string = 'camelcase';
    ...
    description: string = "Use camelcase when naming variables and functions.";
    ruleUrl: string = 'http://eslint.org/docs/rules/camelcase';
