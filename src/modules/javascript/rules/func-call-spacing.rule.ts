...
export class FuncCallSpacingRule implements RuleInterface {
     id: string = 'func-call-spacing';
    ...
    description: string = "No space between function identifiers and their invocations.";
    ruleUrl: string = 'http://eslint.org/docs/rules/func-call-spacing';
