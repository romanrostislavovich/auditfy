...
export class NoSequencesRule implements RuleInterface {
     id: string = 'no-sequences';
    ...
    description: string = "Avoid using the comma operator.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-sequences';
