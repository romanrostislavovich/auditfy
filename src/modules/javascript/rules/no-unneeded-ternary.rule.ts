...
export class NoUnneededTernaryRule implements RuleInterface {
     id: string = 'no-unneeded-ternary';
    ...
    description: string = "No ternary operators when simpler alternatives exist.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-unneeded-ternary';
