...
export class NoDuplicateImportsRule implements RuleInterface {
     id: string = 'no-duplicate-imports';
    ...
    description: string = "Use a single import statement per module.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-duplicate-imports';
