...
export class PaddedBlocksRule implements RuleInterface {
     id: string = 'padded-blocks';
    ...
    description: string = "No padding within blocks.";
    ruleUrl: string = 'http://eslint.org/docs/rules/padded-blocks';
