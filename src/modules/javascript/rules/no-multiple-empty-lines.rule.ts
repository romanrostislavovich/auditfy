...
export class NoMultipleEmptyLinesRule implements RuleInterface {
     id: string = 'no-multiple-empty-lines';
    ...
    description: string = "Multiple blank lines not allowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-multiple-empty-lines';
