...
export class NoExtendNativeRule implements RuleInterface {
     id: string = 'no-extend-native';
    ...
    description: string = "No extending native objects.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-extend-native';
