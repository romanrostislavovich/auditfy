...
export class NoThisBeforeSuperRule implements RuleInterface {
     id: string = 'no-this-before-super';
    ...
    description: string = "super() must be called before using this.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-this-before-super';
