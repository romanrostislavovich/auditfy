...
export class KeySpacingRule implements RuleInterface {
     id: string = 'key-spacing';
    ...
    description: string = "Add space between colon and value in key value pairs.";
    ruleUrl: string = 'http://eslint.org/docs/rules/key-spacing';
