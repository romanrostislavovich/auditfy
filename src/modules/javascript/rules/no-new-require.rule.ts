...
export class NoNewRequireRule implements RuleInterface {
     id: string = 'no-new-require';
    ...
    description: string = "No using new require.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new-require';
