...
export class NoRedeclareRule implements RuleInterface {
     id: string = 'no-redeclare';
    ...
    description: string = "No redeclaring variables.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-redeclare';
