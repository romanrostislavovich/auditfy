...
export class NoUselessComputedKeyRule implements RuleInterface {
     id: string = 'no-useless-computed-key';
    ...
    description: string = "Avoid using unnecessary computed property keys on objects.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-useless-computed-key';
