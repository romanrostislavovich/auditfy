...
export class NoIteratorRule implements RuleInterface {
     id: string = 'no-iterator';
    ...
    description: string = "No using __iterator__.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-iterator';
