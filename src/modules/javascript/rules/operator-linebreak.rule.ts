...
export class OperatorLinebreakRule implements RuleInterface {
     id: string = 'operator-linebreak';
    ...
    description: string = "For the ternary operator";
    ruleUrl: string = 'http://eslint.org/docs/rules/operator-linebreak';
