...
export class NoShadowRestrictedNamesRule implements RuleInterface {
     id: string = 'no-shadow-restricted-names';
    ...
    description: string = "Restricted names should not be shadowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-shadow-restricted-names';
