...
export class NoObjCallsRule implements RuleInterface {
     id: string = 'no-obj-calls';
    ...
    description: string = "No calling global object properties as functions.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-obj-calls';
