...
export class NoIrregularWhitespaceRule implements RuleInterface {
    ...
    description: string = "No irregular whitespace.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-irregular-whitespace';
