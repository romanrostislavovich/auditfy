...
export class NoDebuggerRule implements RuleInterface {
     id: string = 'no-debugger';
    ...
    description: string = "No debugger statements.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-debugger';
