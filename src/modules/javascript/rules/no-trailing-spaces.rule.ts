...
export class NoTrailingSpacesRule implements RuleInterface {
     id: string = 'no-trailing-spaces';
    ...
    description: string = "Whitespace not allowed at end of line.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-trailing-spaces';
