...
export class NoUndefInitRule implements RuleInterface {
     id: string = 'no-undef-init';
    ...
    description: string = "Initializing to undefined is not allowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-undef-init';
