...
export class NoExtraBooleanCastRule implements RuleInterface {
     id: string = 'no-extra-boolean-cast';
    ...
    description: string = "Avoid unnecessary boolean casts.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-extra-boolean-cast';
