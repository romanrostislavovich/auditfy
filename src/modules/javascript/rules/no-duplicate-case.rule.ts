...
export class NoDuplicateCaseRule implements RuleInterface {
     id: string = 'no-duplicate-case';
    ...
    description: string = "No duplicate case labels in switch statements.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-duplicate-case';
