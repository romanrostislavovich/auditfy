...
export class RestSpreadSpacingRule implements RuleInterface {
     id: string = 'rest-spread-spacing';
    ...
    description: string = "No whitespace between spread operators and their expressions.";
    ruleUrl: string = 'http://eslint.org/docs/rules/rest-spread-spacing';
