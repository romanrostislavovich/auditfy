...
export class NoUnsafeNegationRule implements RuleInterface {
     id: string = 'no-unsafe-negation';
    ...
    description: string = "The left operand of relational operators must not be negated.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-unsafe-negation';
