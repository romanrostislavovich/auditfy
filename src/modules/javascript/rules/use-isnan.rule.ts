...
export class UseIsnanRule implements RuleInterface {
     id: string = 'use-isnan';
    ...
    description: string = "Use isNaN() when checking for NaN.";
    ruleUrl: string = 'http://eslint.org/docs/rules/use-isnan';
