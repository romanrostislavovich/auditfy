...
export class NoCallerRule implements RuleInterface {
     id: string = 'no-caller';
    ...
    description: string = "Avoid using arguments.callee and arguments.caller.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-caller';
