...
export class NoNewSymbolRule implements RuleInterface {
     id: string = 'no-new-symbol';
    ...
    description: string = "No using the Symbol constructor.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new-symbol';
