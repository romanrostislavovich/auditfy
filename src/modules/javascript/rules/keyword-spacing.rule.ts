...
export class KeywordSpacingRule implements RuleInterface {
     id: string = 'keyword-spacing';
    ...
    description: string = "Add a space after keywords.";
    ruleUrl: string = 'http://eslint.org/docs/rules/keyword-spacing';
