...
export class NoEmptyPatternRule implements RuleInterface {
     id: string = 'no-empty-pattern';
    ...
    description: string = "No empty destructuring patterns.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-empty-pattern';
