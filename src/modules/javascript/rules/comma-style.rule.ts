...
export class CommaStyleRule implements RuleInterface {
     id: string = 'comma-style';
    ...
    description: string = "Commas must be placed at the end of the current line.";
    ruleUrl: string = 'http://eslint.org/docs/rules/comma-style';
