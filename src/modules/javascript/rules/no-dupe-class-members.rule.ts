...
export class NoDupeClassMembersRule implements RuleInterface {
     id: string = 'no-dupe-class-members';
    ...
    description: string = "No duplicate name in class members.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-dupe-class-members';
