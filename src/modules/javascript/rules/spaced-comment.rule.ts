...
export class SpacedCommentRule implements RuleInterface {
     id: string = 'spaced-comment';
    ...
    description: string = "Use spaces inside comments.";
    ruleUrl: string = 'http://eslint.org/docs/rules/spaced-comment';
