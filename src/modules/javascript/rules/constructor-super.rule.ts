...
export class ConstructorSuperRule implements RuleInterface {
     id: string = 'constructor-super';
    ...
    description: string = "Constructors of derived classes must call super.";
    ruleUrl: string = 'http://eslint.org/docs/rules/constructor-super';
