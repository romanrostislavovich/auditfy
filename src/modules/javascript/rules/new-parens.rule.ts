...
export class NewParensRule implements RuleInterface {
     id: string = 'new-parens';
    ...
    description: string = "Constructor with no arguments must be invoked with parentheses.";
    ruleUrl: string = 'http://eslint.org/docs/rules/new-parens';
