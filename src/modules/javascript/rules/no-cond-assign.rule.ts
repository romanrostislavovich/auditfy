...
export class NoCondAssignRule implements RuleInterface {
     id: string = 'no-cond-assign';
    ...
    description: string = "Wrap conditional assignments";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-cond-assign';
