...
export class NoUselessCallRule implements RuleInterface {
     id: string = 'no-useless-call';
    ...
    description: string = "Avoid unnecessary use of .call() and .apply().";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-useless-call';
