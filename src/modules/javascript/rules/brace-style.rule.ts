...
export class BraceStyleRule implements RuleInterface {
     id: string = 'brace-style';
    ...
    description: string = "Keep else statements";
    ruleUrl: string = 'http://eslint.org/docs/rules/brace-style';
