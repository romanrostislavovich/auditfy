...
export class DotLocationRule implements RuleInterface {
     id: string = 'dot-location';
    ...
    description: string = "Dot should be on the same line as property.";
    ruleUrl: string = 'http://eslint.org/docs/rules/dot-location';
