...
export class NoExtraParensRule implements RuleInterface {
     id: string = 'no-extra-parens';
    ...
    description: string = "No unnecessary parentheses around function expressions.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-extra-parens';
