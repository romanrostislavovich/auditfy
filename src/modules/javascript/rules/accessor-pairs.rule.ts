...
export class AccessorPairsRule implements RuleInterface {
     id: string = 'accessor-pairs';
    ...
    description: string = "Objects must contain a getter when a setter is defined.";
    ruleUrl: string = 'http://eslint.org/docs/rules/accessor-pairs';
