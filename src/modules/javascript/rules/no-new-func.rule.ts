...
export class NoNewFuncRule implements RuleInterface {
     id: string = 'no-new-func';
    ...
    description: string = "No using the Function constructor.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new-func';
