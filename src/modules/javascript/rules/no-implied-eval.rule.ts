...
export class NoImpliedEvalRule implements RuleInterface {
     id: string = 'no-implied-eval';
    ...
    description: string = "No implied eval().";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-implied-eval';
