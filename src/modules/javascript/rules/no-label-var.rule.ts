...
export class NoLabelVarRule implements RuleInterface {
     id: string = 'no-label-var';
    ...
    description: string = "No labels that share a name with an in scope variable.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-label-var';
