...
export class NoFloatingDecimalRule implements RuleInterface {
     id: string = 'no-floating-decimal';
    ...
    description: string = "No floating decimals.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-floating-decimal';
