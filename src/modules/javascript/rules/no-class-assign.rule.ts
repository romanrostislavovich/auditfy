...
export class NoClassAssignRule implements RuleInterface {
     id: string = 'no-class-assign';
    ...
    description: string = "Avoid modifying variables of class declarations.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-class-assign';
