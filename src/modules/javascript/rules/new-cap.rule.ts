...
export class NewCapRule implements RuleInterface {
     id: string = 'new-cap';
    ...
    description: string = "Constructor names must begin with a capital letter.";
    ruleUrl: string = 'http://eslint.org/docs/rules/new-cap';
