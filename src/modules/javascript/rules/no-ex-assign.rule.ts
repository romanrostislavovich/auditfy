...
export class NoExAssignRule implements RuleInterface {
     id: string = 'no-ex-assign';
    ...
    description: string = "No reassigning exceptions in catch clauses.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-ex-assign';
