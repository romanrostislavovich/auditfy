...
export class NoDeleteVarRule implements RuleInterface {
     id: string = 'no-delete-var';
    ...
    description: string = "No delete operator on variables.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-delete-var';
