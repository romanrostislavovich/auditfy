...
export class NoArrayConstructorRule implements RuleInterface {
     id: string = 'no-array-constructor';
    ...
    description: string = "Use array literals instead of array constructors.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-array-constructor';
