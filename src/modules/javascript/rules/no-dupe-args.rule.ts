...
export class NoDupeArgsRule implements RuleInterface {
     id: string = 'no-dupe-args';
    ...
    description: string = "No duplicate arguments in function definitions.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-dupe-args';
