...
export class NoNewObjectRule implements RuleInterface {
     id: string = 'no-new-object';
    ...
    description: string = "No using the Object constructor.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-new-object';
