...
export class NoUnmodifiedLoopConditionRule implements RuleInterface {
     id: string = 'no-unmodified-loop-condition';
    ...
    description: string = "No unmodified conditions of loops.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-unmodified-loop-condition';
