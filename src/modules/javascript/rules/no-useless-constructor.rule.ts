...
export class NoUselessConstructorRule implements RuleInterface {
     id: string = 'no-useless-constructor';
    ...
    description: string = "No unnecessary constructor.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-useless-constructor';
