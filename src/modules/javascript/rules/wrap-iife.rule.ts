...
export class WrapIifeRule implements RuleInterface {
     id: string = 'wrap-iife';
    ...
    description: string = "Immediately Invoked Function Expressions (IIFEs) must be wrapped.";
    ruleUrl: string = 'http://eslint.org/docs/rules/wrap-iife';
