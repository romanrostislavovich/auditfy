...
export class TemplateCurlySpacingRule implements RuleInterface {
     id: string = 'template-curly-spacing';
    ...
    description: string = "No spacing in template strings.";
    ruleUrl: string = 'http://eslint.org/docs/rules/template-curly-spacing';
