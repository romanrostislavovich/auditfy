...
export class NoThrowLiteralRule implements RuleInterface {
     id: string = 'no-throw-literal';
    ...
    description: string = "Only throw an Error object.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-throw-literal';
