...
export class NoUselessRenameRule implements RuleInterface {
     id: string = 'no-useless-rename';
    ...
    description: string = "Renaming import, export, and destructured assignments to the same name is not allowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-useless-rename';
