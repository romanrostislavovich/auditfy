...
export class ValidTypeofRule implements RuleInterface {
     id: string = 'valid-typeof';
    ...
    description: string = "typeof must be compared to a valid string.";
    ruleUrl: string = 'http://eslint.org/docs/rules/valid-typeof';
