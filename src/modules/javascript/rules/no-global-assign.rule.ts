...
export class NoGlobalAssignRule implements RuleInterface {
     id: string = 'no-global-assign';
    ...
    description: string = "No reassigning read-only global variables.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-global-assign';
