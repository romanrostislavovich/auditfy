...
export class CommaDangleRule implements RuleInterface {
     id: string = 'comma-dangle';
    ...
    description: string = "Trailing commas not allowed.";
    ruleUrl: string = 'http://eslint.org/docs/rules/comma-dangle';
