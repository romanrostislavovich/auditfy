...
export class NoInnerDeclarationsRule implements RuleInterface {
     id: string = 'no-inner-declarations';
    ...
    description: string = "No function declarations in nested blocks.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-inner-declarations';
