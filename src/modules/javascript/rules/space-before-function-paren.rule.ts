...
export class SpaceBeforeFunctionParenRule implements RuleInterface {
     id: string = 'space-before-function-paren';
    ...
    description: string = "Add a space before a function declaration's parentheses.";
    ruleUrl: string = 'http://eslint.org/docs/rules/space-before-function-paren';
