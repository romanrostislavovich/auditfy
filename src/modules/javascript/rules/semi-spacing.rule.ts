...
export class SemiSpacingRule implements RuleInterface {
     id: string = 'semi-spacing';
    ...
    description: string = "Semicolons must have a space after and no space before.";
    ruleUrl: string = 'http://eslint.org/docs/rules/semi-spacing';
