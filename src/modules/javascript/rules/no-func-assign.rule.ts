...
export class NoFuncAssignRule implements RuleInterface {
     id: string = 'no-func-assign';
    ...
    description: string = "Avoid reassigning function declarations.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-func-assign';
