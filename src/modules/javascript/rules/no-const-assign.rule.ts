...
export class NoConstAssignRule implements RuleInterface {
     id: string = 'no-const-assign';
    ...
    description: string = "Avoid modifying variables declared using const.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-const-assign';
