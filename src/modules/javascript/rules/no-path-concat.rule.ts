...
export class NoPathConcatRule implements RuleInterface {
     id: string = 'no-path-concat';
    ...
    description: string = "Avoid string concatenation when using __dirname and __filename.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-path-concat';
