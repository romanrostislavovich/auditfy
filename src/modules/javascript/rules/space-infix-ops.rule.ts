...
export class SpaceInfixOpsRule implements RuleInterface {
     id: string = 'space-infix-ops';
    ...
    description: string = "Infix operators";
    ruleUrl: string = 'http://eslint.org/docs/rules/space-infix-ops';
