...
export class NoLoneBlocksRule implements RuleInterface {
     id: string = 'no-lone-blocks';
    ...
    description: string = "No unnecessary nested blocks.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-lone-blocks';
