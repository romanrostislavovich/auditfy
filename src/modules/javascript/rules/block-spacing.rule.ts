...
export class BlockSpacingRule implements RuleInterface {
    ...
    description: string = "Add spaces inside single line blocks.";
    ruleUrl: string = 'http://eslint.org/docs/rules/block-spacing';
