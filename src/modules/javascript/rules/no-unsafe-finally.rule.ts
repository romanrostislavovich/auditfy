...
export class NoUnsafeFinallyRule implements RuleInterface {
     id: string = 'no-unsafe-finally';
    ...
    description: string = "No flow control statements in finally blocks.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-unsafe-finally';
