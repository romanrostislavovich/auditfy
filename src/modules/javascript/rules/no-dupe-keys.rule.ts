...
export class NoDupeKeysRule implements RuleInterface {
     id: string = 'no-dupe-keys';
    ...
    description: string = "No duplicate keys in object literals.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-dupe-keys';
