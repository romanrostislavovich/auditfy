...
export class NoWhitespaceBeforePropertyRule implements RuleInterface {
     id: string = 'no-whitespace-before-property';
    ...
    description: string = "No whitespace before properties.";
    ruleUrl: string = 'http://eslint.org/docs/rules/no-whitespace-before-property';
