...
export class ScriptElementRule implements RuleInterface {
    id: string = 'script-element';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Require end tag for `<script>`';
    ruleUrl: string = 'https://html-validate.org//rules/script-element.html';
