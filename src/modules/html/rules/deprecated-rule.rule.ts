...
export class DeprecatedRuleRule implements RuleInterface {
    id: string = 'deprecated-rule';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Disallow usage of deprecated rules';
    ruleUrl: string = 'https://html-validate.org//rules/deprecated-rule.html';
