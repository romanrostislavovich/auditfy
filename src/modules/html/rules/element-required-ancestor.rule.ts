...
export class ElementRequiredAncestorRule implements RuleInterface {
    id: string = 'element-required-ancestor';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Validate required element ancestors';
    ruleUrl: string = 'https://html-validate.org//rules/element-required-ancestor.html';
