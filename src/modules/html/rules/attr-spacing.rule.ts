...
export class AttrSpacingRule implements RuleInterface {
    id: string = 'attr-spacing';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Require attributes to be separated by whitespace';
    ruleUrl: string = 'https://html-validate.org//rules/attr-spacing.html';
