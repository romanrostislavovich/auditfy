...
export class MapIdNameRule implements RuleInterface {
    id: string = 'map-id-name';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Require name and id to match on <map> elements';
    ruleUrl: string = 'https://html-validate.org//rules/map-id-name.html';
