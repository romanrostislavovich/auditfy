...
export class CloseAttrRule implements RuleInterface {
    id: string = 'close-attr';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Disallow end tags from having attributes';
    ruleUrl: string = 'https://html-validate.org//rules/close-attr.html';
