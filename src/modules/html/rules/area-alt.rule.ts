...
export class AreaAltRule implements RuleInterface {
    id: string = 'area-alt';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    ...
    description: string = 'Require alternative text on `<area>` elements';
    ruleUrl: string = 'https://html-validate.org//rules/area-alt.html';
