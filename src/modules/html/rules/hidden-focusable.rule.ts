...
export class HiddenFocusableRule implements RuleInterface {
    id: string = 'hidden-focusable';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Disallows `aria-hidden` on focusable elements';
    ruleUrl: string = 'https://html-validate.org//rules/hidden-focusable.html';
