...
export class NoDupClassRule implements RuleInterface {
    id: string = 'no-dup-class';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Disallow duplicated classes';
    ruleUrl: string = 'https://html-validate.org//rules/no-dup-class.html';
