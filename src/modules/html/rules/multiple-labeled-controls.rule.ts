...
export class MultipleLabeledControlsRule implements RuleInterface {
    id: string = 'multiple-labeled-controls';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    lightHouse: LightHouseAuditType;
    ruleFlow: MessageType = MessageType.warning;
    htmlValidator: Result[];
    description: string = 'Disallow labels associated with multiple controls';
    ruleUrl: string = 'https://html-validate.org//rules/multiple-labeled-controls.html';
