...
export class WcagH30Rule implements RuleInterface {
    id: string = 'wcag-h30';
    dom: CheerioAPI;
    tags: string[] = ['html'];
    ...
    description: string = 'WCAG H30: Providing link text';
    ruleUrl: string = 'https://html-validate.org//rules/wcag/h30.html';
